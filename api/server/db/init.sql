...
-- 衣橱管家业务表
-- ----------------------------
CREATE TABLE IF NOT EXISTS `app_wardrobe_profile` (
  `profile_id` varchar(36) NOT NULL, `user_id` varchar(64) NOT NULL, `nickname` varchar(64) NOT NULL DEFAULT '衣橱用户',
  `height` int DEFAULT NULL, `weight` int DEFAULT NULL, `body_shape` varchar(32) NOT NULL DEFAULT '', `skin_tone` varchar(32) NOT NULL DEFAULT '',
  `style_preferences` text, `avoid_colors` text, `brand_preferences` text, `is_pro` tinyint NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `app_clothing_item` (
  ...
  `color` varchar(64) NOT NULL DEFAULT '', `texture` varchar(64) NOT NULL DEFAULT '', `brand` varchar(64) NOT NULL DEFAULT '', `season` varchar(32) NOT NULL DEFAULT '四季',
  `image_url` varchar(500) NOT NULL DEFAULT '', `tags` text, `is_favorite` tinyint NOT NULL DEFAULT 0, `is_frequent` tinyint NOT NULL DEFAULT 0, `ai_confidence` int NOT NULL DEFAULT 0,
  `create_by` varchar(64) NOT NULL DEFAULT '', `create_time` datetime DEFAULT CURRENT_TIMESTAMP, `update_by` varchar(64) NOT NULL DEFAULT '',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `remark` varchar(500) DEFAULT NULL, `status` char(1) NOT NULL DEFAULT '0', `del_flag` char(1) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `app_outfit` (
  ...
  `reason` text NOT NULL, `score` int NOT NULL DEFAULT 0, `clothing_ids` text, `pieces` text, `colors` text, `weather` varchar(120) NOT NULL DEFAULT '', `is_saved` tinyint NOT NULL DEFAULT 0,
  `preview_image_url` varchar(500) NOT NULL DEFAULT '', `render_status` varchar(16) NOT NULL DEFAULT 'pending', `render_error` varchar(500) NOT NULL DEFAULT '',
  `try_on_person_url` varchar(500) NOT NULL DEFAULT '', `try_on_image_url` varchar(500) NOT NULL DEFAULT '', `try_on_task_id` varchar(80) NOT NULL DEFAULT '',
  `try_on_status` varchar(24) NOT NULL DEFAULT 'idle', `try_on_error` varchar(500) NOT NULL DEFAULT '',
  `create_by` varchar(64) NOT NULL DEFAULT '', `create_time` datetime DEFAULT CURRENT_TIMESTAMP, `update_by` varchar(64) NOT NULL DEFAULT '',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `remark` varchar(500) DEFAULT NULL, `status` char(1) NOT NULL DEFAULT '0', `del_flag` char(1) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `app_try_on_record` (
  ...
  `outfit_title` varchar(120) NOT NULL DEFAULT '', `scene` varchar(32) NOT NULL DEFAULT '', `clothing_ids` text,
  `person_image_url` varchar(500) NOT NULL DEFAULT '', `top_garment_url` varchar(500) NOT NULL DEFAULT '',
  `bottom_garment_url` varchar(500) NOT NULL DEFAULT '', `result_image_url` varchar(500) NOT NULL DEFAULT '',
  `task_id` varchar(80) NOT NULL DEFAULT '', `try_on_status` varchar(24) NOT NULL DEFAULT 'submitting',
  `error_message` varchar(500) NOT NULL DEFAULT '', `create_by` varchar(64) NOT NULL DEFAULT '',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP, `update_by` varchar(64) NOT NULL DEFAULT '',
...
INSERT INTO `app_try_on_record` (
  ...
  `person_image_url`, `result_image_url`, `task_id`, `try_on_status`, `error_message`,
  `create_time`, `update_time`
)
SELECT
  UUID(), o.`user_id`, o.`outfit_id`, o.`title`, o.`scene`, o.`clothing_ids`,
  o.`try_on_person_url`, o.`try_on_image_url`, o.`try_on_task_id`, o.`try_on_status`, o.`try_on_error`,
  o.`create_time`, o.`update_time`
FROM `app_outfit` o
WHERE o.`del_flag` = '0'
  AND (o.`try_on_person_url` <> '' OR o.`try_on_image_url` <> '' OR o.`try_on_task_id` <> '')
  AND NOT EXISTS (
    SELECT 1 FROM `app_try_on_record` r
    WHERE r.`outfit_id` = o.`outfit_id` AND r.`del_flag` = '0'
  );

CREATE TABLE IF NOT EXISTS `app_style_challenge` (
  `challenge_id` varchar(36) NOT NULL, `tag` varchar(64) NOT NULL, `title` varchar(120) NOT NULL, `reward` varchar(64) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `app_community_submission` (
  ...
  `image_url` varchar(500) NOT NULL DEFAULT '', `content` text, `ai_score` int NOT NULL DEFAULT 0, `audit_status` char(1) NOT NULL DEFAULT '0', `audit_reason` varchar(500) NOT NULL DEFAULT '',
  `create_by` varchar(64) NOT NULL DEFAULT '', `create_time` datetime DEFAULT CURRENT_TIMESTAMP, `update_by` varchar(64) NOT NULL DEFAULT '',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `remark` varchar(500) DEFAULT NULL, `status` char(1) NOT NULL DEFAULT '0', `del_flag` char(1) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `app_ai_call_log` (
  ...
  `call_status` char(1) NOT NULL DEFAULT '0', `duration_ms` int NOT NULL DEFAULT 0, `error_message` text,
  `create_by` varchar(64) NOT NULL DEFAULT '', `create_time` datetime DEFAULT CURRENT_TIMESTAMP, `update_by` varchar(64) NOT NULL DEFAULT '',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `remark` varchar(500) DEFAULT NULL, `status` char(1) NOT NULL DEFAULT '0', `del_flag` char(1) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `app_user_feedback` (
  ...
  `content` text NOT NULL, `contact` varchar(120) NOT NULL DEFAULT '', `handle_status` char(1) NOT NULL DEFAULT '0', `reply` varchar(1000) NOT NULL DEFAULT '',
  `create_by` varchar(64) NOT NULL DEFAULT '', `create_time` datetime DEFAULT CURRENT_TIMESTAMP, `update_by` varchar(64) NOT NULL DEFAULT '',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `remark` varchar(500) DEFAULT NULL, `status` char(1) NOT NULL DEFAULT '0', `del_flag` char(1) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `app_user_membership` (
  ...
  `expire_time` datetime DEFAULT NULL, `wardrobe_limit` int NOT NULL DEFAULT 30, `member_status` char(1) NOT NULL DEFAULT '0',
  `create_by` varchar(64) NOT NULL DEFAULT '', `create_time` datetime DEFAULT CURRENT_TIMESTAMP, `update_by` varchar(64) NOT NULL DEFAULT '',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `remark` varchar(500) DEFAULT NULL, `status` char(1) NOT NULL DEFAULT '0', `del_flag` char(1) NOT NULL DEFAULT '0',
...
(2000,'衣橱运营',0,4,'wardrobe',NULL,'','1','0','M','0','0','','shopping','admin','衣橱管家运营目录','0'),
(2001,'运营概览',2000,1,'overview','wardrobe/index','','1','0','C','0','0','wardrobe:overview:list','dashboard','admin','','0'),
(2002,'APP用户',2000,2,'users','wardrobe/users/index','','1','0','C','0','0','wardrobe:user:list','user','admin','','0'),
(2003,'衣物管理',2000,3,'clothing','wardrobe/clothing/index','','1','0','C','0','0','wardrobe:clothing:list','shopping','admin','','0'),
(2004,'搭配记录',2000,4,'outfits','wardrobe/outfits/index','','1','0','C','0','0','wardrobe:outfit:list','list','admin','','0'),
(2005,'挑战主题',2000,5,'challenges','wardrobe/challenges/index','','1','0','C','0','0','wardrobe:admin:list','star','admin','','0'),
(2006,'投稿审核',2000,6,'submissions','wardrobe/submissions/index','','1','0','C','0','0','wardrobe:admin:list','checkbox','admin','','0'),
(2007,'AI调用日志',2000,7,'ai-logs','wardrobe/ai-logs/index','','1','0','C','0','0','wardrobe:admin:list','log','admin','','0'),
(2008,'用户反馈',2000,8,'feedback','wardrobe/feedback/index','','1','0','C','0','0','wardrobe:admin:list','message','admin','','0'),
(2009,'会员管理',2000,9,'memberships','wardrobe/memberships/index','','1','0','C','0','0','wardrobe:admin:list','money','admin','','0'),
(2010,'运营数据编辑',2000,10,'#','','','1','0','F','0','0','wardrobe:admin:edit','#','admin','','0'),
(2011,'运营数据删除',2000,11,'#','','','1','0','F','0','0','wardrobe:admin:remove','#','admin','','0'),
(2012,'挑战新增',2005,1,'#','','','1','0','F','0','0','wardrobe:challenge:add','#','admin','','0'),
(2013,'挑战修改',2005,2,'#','','','1','0','F','0','0','wardrobe:challenge:edit','#','admin','','0'),
(2014,'会员修改',2009,1,'#','','','1','0','F','0','0','wardrobe:member:edit','#','admin','','0')
...
`icon`=VALUES(`icon`), `remark`=VALUES(`remark`), `del_flag`=VALUES(`del_flag`);

INSERT IGNORE INTO `sys_role_menu` (`role_id`,`menu_id`) SELECT 2, `menu_id` FROM `sys_menu` WHERE `menu_id` BETWEEN 2000 AND 2014;
